...
function buildPrompts(problemText: string, solutionText: string, inputs: BrandingInputs, colorsModified?: boolean) {
  ...
  const flatPrompt = [
    ...
    `- Brand Personality Adjectives: ${ctx.brand_personality_adjectives.join(', ') || 'N/A'}`,
  ...
  const flatLogoConceptsPrompt = [
    ...
    `Brand Personality: ${ctx.brand_personality_adjectives.join(', ') || 'N/A'}`,
    inputs.competitors?.length ? `Competitors: ${ctx.competitors.join(', ')}` : null,
