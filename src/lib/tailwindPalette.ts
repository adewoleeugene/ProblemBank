...
// Expanded Tailwind palette (common families and scales 50–900)
...
// Grouped colors by family for better UX
export const COLOR_FAMILIES: ColorFamily[] = [
  ...
  {
    name: 'Slate',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('slate-')),
  },
  {
    name: 'Gray',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('gray-')),
  },
  {
    name: 'Zinc',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('zinc-')),
  },
  {
    name: 'Neutral',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('neutral-')),
  },
  {
    name: 'Stone',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('stone-')),
  },
  {
    name: 'Red',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('red-')),
  },
  {
    name: 'Orange',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('orange-')),
  },
  {
    name: 'Amber',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('amber-')),
  },
  {
    name: 'Yellow',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('yellow-')),
  },
  {
    name: 'Lime',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('lime-')),
  },
  {
    name: 'Green',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('green-')),
  },
  {
    name: 'Emerald',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('emerald-')),
  },
  {
    name: 'Teal',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('teal-')),
  },
  {
    name: 'Cyan',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('cyan-')),
  },
  {
    name: 'Sky',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('sky-')),
  },
  {
    name: 'Blue',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('blue-')),
  },
  {
    name: 'Indigo',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('indigo-')),
  },
  {
    name: 'Violet',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('violet-')),
  },
  {
    name: 'Purple',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('purple-')),
  },
  {
    name: 'Fuchsia',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('fuchsia-')),
  },
  {
    name: 'Pink',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('pink-')),
  },
  {
    name: 'Rose',
    colors: TAILWIND_COLORS.filter(c => c.name.startsWith('rose-')),
  },
];
